  ...
  render() {
    return (
      <div>
        ...
        could be earning
        {' '}
        <a href="https://www.glassdoor.com/blog/average-american-underpaid-7500/">
        ...
        <ul>
          <li>
            The key to getting better at negotiating is to
            {' '}
            <b>
              PRACTICE.
            </b>
            This is why PayMe has a
            {' '}
            <i>
          ...
          <li>
            ...
            {' '}
            PayMe has gathered all of the research for you
                        in our
            {' '}
            <i>
              Negotiation Tips
          ...
          <li>
            ...
            <b>
              enthusiasm.
                        ...
                        According to
            {' '}
            <a href="http://www.businessinsider.com/how-to-negotiate-a-salary-2018-3?utm_content=buffer20a46&utm_medium=social&utm_source=facebook.com&utm_campaign=buffer-careers">
              Business Insider,
            </a>
          ...
          <li>
            When asking for that raise, make sure you tell your supervisor
            {' '}
            <b>
              what you have already done for the company
            </b>
            {' '}
            and why you deserve to be paid more. You can jot down
                        your accomplishments in our PayMe
            {' '}
            <i>
              Milestones
            </i>
