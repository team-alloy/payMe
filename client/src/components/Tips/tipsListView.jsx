  ...
  render() {
    return (
      <div>
        ...
        <ul>
          <li>
            1) The key to getting better at negotiating is to <b>PRACTICE.</b> 
            This is why PayMe has a <i>Negotiation Practice</i> section for you 
            to practice with a partner.
          </li>
          <li>
            2) Know <b>your number.</b> PayMe has gathered all of the research for you 
          ...
          <li>
            3) Start the negotiation conversation with <b>enthusiasm.</b>
          ...
          <li>
            4) <b>Don't be apologetic</b> in asking for more money. 
          ...
          <li>
            5) When asking for that raise, make sure you tell your supervisor <b>what you have 
